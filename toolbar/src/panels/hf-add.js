...
ETB.hfAdd = (function () {
  ...
  var STYLES = [
    '#_etbv2_hf_ov{',
      ...
      'font-family:var(--etb-sans,"Nunito",system-ui,sans-serif);',
    ...
    '._etbv2_hf_title{font-size:15px;font-weight:700;color:var(--etb-tx,#111);margin-bottom:4px;}',
    '._etbv2_hf_sub{font-size:13px;color:var(--etb-tx2,#6b6b6b);line-height:1.6;}',
    ...
    '}',
    '._etbv2_hf_prev_name{font-size:15px;font-weight:700;color:var(--etb-tx,#111);margin-bottom:3px;}',
    ...
    '._etbv2_hf_res_item{font-size:11px;color:var(--etb-tx2,#6b6b6b);}',
    '._etbv2_hf_res_item b{color:var(--etb-tx,#111);font-weight:600;}',
    /* Run-mode selector */
    '._etbv2_hf_modes{display:flex;gap:8px;margin-bottom:16px;}',
    '._etbv2_hf_mode_card{flex:1;border:2px solid var(--etb-bd2,rgba(0,0,0,.14));border-radius:12px;',
      'padding:16px;cursor:pointer;transition:all .15s;user-select:none;}',
    ...
    '._etbv2_hf_mode_card .mode_icon{font-size:20px;margin-bottom:8px;}',
    '._etbv2_hf_mode_card .mode_title{font-size:13px;font-weight:700;color:var(--etb-tx,#111);margin-bottom:3px;}',
    ...
    /* Status */
    '#_etbv2_hf_status{',
      'font-size:13px;color:var(--etb-tx2,#6b6b6b);margin-bottom:12px;',
    ...
    '._etbv2_hf_btn_cancel{',
      ...
      'border-radius:12px;padding:8px 20px;cursor:pointer;font-size:13px;font-family: 'Nunito', system-ui, sans-serif;',
    '}',
    ...
    '._etbv2_hf_btn_primary{',
      ...
      'transition:opacity .12s;font-family: 'Nunito', system-ui, sans-serif;',
    '}',
    '._etbv2_hf_btn_primary:hover{opacity:.85;}',
    '._etbv2_hf_btn_primary:disabled{opacity:.4;cursor:not-allowed;}',
    /* Progress */
    '._etbv2_hf_prog{margin:8px 0 16px;}',
    '._etbv2_hf_prog_row{display:flex;align-items:center;gap:8px;margin-bottom:12px;}',
    '._etbv2_hf_prog_phase{flex:1;font-size:13px;font-weight:600;color:var(--etb-tx,#111);}',
    '._etbv2_hf_prog_time{font-size:13px;color:var(--etb-tx2,#6b6b6b);font-variant-numeric:tabular-nums;}',
    '._etbv2_hf_bar{position:relative;height:5px;border-radius:8px;background:var(--etb-bd2,rgba(0,0,0,.1));overflow:hidden;}',
    '._etbv2_hf_bar_fill{position:absolute;top:0;left:0;height:100%;width:38%;border-radius:8px;',
    ...
    '._etbv2_hf_activity{',
      ...
      'border-radius:12px;padding:8px 12px;max-height:120px;overflow-y:auto;',
      'font-family:var(--etb-mono,"JetBrains Mono",ui-monospace,Menlo,monospace);font-size:11px;color:var(--etb-tx2,#6b6b6b);line-height:1.6;',
