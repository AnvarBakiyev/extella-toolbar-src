...
ETB.hfAdd = (function () {
  ...
  var STYLES = [
    ...
    '._etbv2_hf_btn_cancel{',
      ...
      'border-radius:12px;padding:9px 20px;cursor:pointer;font-size:12px;font-family:inherit;',
    '}',
    ...
    '._etbv2_hf_activity{',
      ...
      'border-radius:12px;padding:10px 12px;max-height:120px;overflow-y:auto;',
